            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        ...
                        <th class="px-4 py-3">{{__('ნომერი')}}</th>
                        <th class="px-4 py-3">{{__('მოდელი')}}</th>
                        <th class="px-4 py-3">{{__('ფერი')}}</th>
                        <th class="px-4 py-3">{{__('ადგილების რაოდენობა')}}</th>
                        <th class="px-4 py-3"></th>
                    </tr>
                    </thead>
                    ...
                    @foreach($buses as $key => $bus)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm inline-flex">
                                <a href="{{ route('buses.edit', $bus->id) }}" class="inline-flex">
